...
enum QIFTypeParsingError: LocalizedError {
    case incorrectFormat, invalidType, noValidSections
    ...
    var errorDescription: String? {
        ...
        case .noValidSections: error = "No valid sections found. Sections can only be Cash, Bank, CCard, Oth L, or Oth A"
        }
